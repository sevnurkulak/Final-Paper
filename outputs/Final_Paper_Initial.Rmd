...
abstract: " Stress has been one of the main important health concerns over the years. It is important to identify specific stress factors in different age groups and in different locations so that any actions can be taken for its reduction. This paper focuses on several stress factors in Canada, looking specifically at different age groups and locations to see if there are any common stress factors within these groups. "
